...
module.exports = {
  'hover浮层': function hover(browser) {
    ...
    handleHover(browser, '#ttbar-mycity', '.dd.dropdown-layer', '定位城市hover').useXpath().click('//div[@class="ui-areamini-content-list"]/div[@class="item"]/a[text()="河南"]').assert.containsText('//span[@class="ui-areamini-text"]', '河南', '定位城市切换');
    /* -----------  我的京东  ----------- */
    ...
    handleHover(browser, '//div[@class="tab top_tab"]/div[@class="tab_head"]/div[contains(@class,"tab_head_item")][2]', '//div[@class="tab top_tab"]/div[@class="tab_body"]/div[contains(@class,"tab_body_item")][2]', '排行榜hover').end();
  },
  'click事件': function click(browser) {
    ...
    scrollToElement(browser, '#J_feeds').click('//li[@id="feedTab1"]');
    ...
    checkBackToElement(browser, '//a[@class="elevator_totop"]', '//li[@id="J_mobile"]', '点击“电梯-回到顶部”').end();
  }
};